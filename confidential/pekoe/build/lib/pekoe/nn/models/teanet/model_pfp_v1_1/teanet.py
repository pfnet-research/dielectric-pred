...
class TeaNetParameters_v1_1:
    ...
    @classmethod
    def from_dict(class_, d: Dict[Any, Any]) -> "TeaNetParameters_v1_1":
...
class TeaNet_v1_1(TeaNetBase):
    ...
    def __init__(
        self,
        parameters: TeaNetParameters_v1_1,
    ):
        super(TeaNet_v1_1, self).__init__()
