...
from pekoe.nn.models.teanet.model_pfp_v1_1.teanet import TeaNetParameters_v1_1


def test_from_yaml(pytestconfig):
    base_config = BaseConfig.from_yaml(DEFAULT_MODEL_DIRECTORY / "model_v1_1_0.yaml")

    parameters = TeaNetParameters_v1_1.from_dict(base_config.parameters)
