...
class GatedEquivariantBlock(nn.Module):
    def __init__(
        ...
        integrate_nv_nt: bool = True,
        integrate_es_ev: bool = True):
        ...
        Args:
            ...
            integrate_nv_nt: whether to integrate node vectors/tensors information
    ...
    def forward(
        ...
        if not self.integrate_es_ev:
            h_nv_ev1, h_nv_ev2 = torch.zeros_like(h_nv_ev1), torch.zeros_like(h_nv_ev2)
